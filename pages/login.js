        ...
        <div className="rounded ring-2 ring-sky-400 bg-blue-100 ml-[30vw] w-[40vw] mt-[9vh] place-items-center h-auto py-[5vh] bg-[url('/navbar.jpg')] bg-cover">
          ...
          >
            <div className="px-5 py-2 ">
              ...
              />
                 <svg class="absolute w-8 h-8 text-sky-400 -mt-[6vh] mx-[27vw] bg-transparent  " stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg> 
                  ...
                  <span>
                    {view ? (
                      <svg
                        ...
                        class=" absolute w-7 h-7  bg-transparent  text-sky-400 mt-3 mx-[27vw]" 
